...
| V2 update encoding | port note shipped ([update-v2.md](docs/yrs-port-notes/update-v2.md)); implementation pending (~1100-1700 LOC: lib0 RLE primitives → V2 column codec → public API → cross-language fixtures) |
